...
X_predict[0,:] = [1.001,1.001001,0.001]
X_predict[1,:] = [1.005,1.001005,0.001]
X_predict[2,:] = [1.1,1.0011,0.001]
print(X_predict)
...
#    y_train.append(y[i])
XX_train = []
XX_train = [data.loc[:,"Time"].values,data.loc[:,"Velocity"].values, data.loc[:,"Acceleration"].values]
...
#model.add(layers.Input(shape=(X_train.shape[1], X_train.shape[4])))
